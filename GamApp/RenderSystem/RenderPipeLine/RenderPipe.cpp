...
void RenderPipe::BuildBuffers()
{
	...
	RENDERDEVICE::Instance().g_pD3DDevice->CreateTexture(RENDERDEVICE::Instance().g_pD3DPP.BackBufferWidth, RENDERDEVICE::Instance().g_pD3DPP.BackBufferHeight,
		1, D3DUSAGE_RENDERTARGET,
		D3DFMT_A8R8G8B8, D3DPOOL_DEFAULT,
		&m_pGrayscaleTarget, NULL);
	hr = m_pGrayscaleTarget->GetSurfaceLevel(0, &m_pGrayscaleSurface);
...
void RenderPipe::RenderGBuffer()
{
	...
	RENDERDEVICE::Instance().g_pD3DDevice->SetRenderTarget(3, m_pGrayscaleSurface);
