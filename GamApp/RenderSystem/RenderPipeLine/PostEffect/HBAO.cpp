...
void HBAO::CreatePostEffect()
{
	PostEffectBase::CreatePostEffect("System\\HBAO.fx", D3DFMT_A16B16G16R16F);
...
void HBAO::RenderPost(LPDIRECT3DTEXTURE9 mainBuffer)
{
